...
def update_graph(xaxis_column_name, yaxis_column_name,
    ...
    return {
        'data': [dict(
            x=dff[dff['City'] == xaxis_column_name]['median'],
            y=dff[dff['City'] == yaxis_column_name]['median'],
            text=dff[dff['City'] == yaxis_column_name]['median'],
            customdata=dff[dff['City'] == yaxis_column_name]['median'],
            mode='markers',
            marker={
                'size': 15,
                'opacity': 0.5,
